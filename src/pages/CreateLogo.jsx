...
export default function CreateLogo() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await api.post("/admin/logo/createLogo", formData, {
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="bg-white rounded-xl shadow-sm border p-6 w-full">
            ...
            <h2 className="text-2xl font-semibold mb-6">Create Logo</h2>
              ...
              <div>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <input
                      {...field}
                      placeholder="Enter logo title (optional)"
    ...
    <p className="text-red-600 text-sm mt-1">
      {errors.title.message}
              ...
              <div className="text-center pt-4">
                ...
                >
                  {isSubmitting ? "Saving..." : "Create Logo"}
                </button>
              </div>
            </form>
          </div>
