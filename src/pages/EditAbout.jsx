...
export default function EditAbout() {
  ...
  const fetchAbout = async () => {
    try {
      ...
      const about = res.data.data.find((a) => a.id === Number(id));
      ...
      setPreview(
        about.image
          ? `${import.meta.env.VITE_API_BASE_URL}${about.image}`
          : null
      );
    } catch (err) {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await api.put("/admin/about/updateAbout", formData, {
